...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="{{route('cargarusuarios.index')}}" onclick="" ><i class="fa fa-circle-o"></i>Cargar Datos Us. </a></li>
            ...
            <li class="treeview">
              ...
              <a href="#">
                <i class="fa fa-fw fa-user-plus"></i> <span>Gerencia</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{route('gerencia.index')}}" ><i class="fa fa-circle-o"></i>Cargar Horarios</a></li>
    ...
    <!-- jQuery 2.1.4
    SE COMENTO POR SI ACASO PERO HAY QUE DESCOMENTARSE -->
