...
//funcion que carga todos los formularios del sistema
    ...
    if(arg==2){ var url = "cargarusuarios"; }
    if(arg==3){ var url = "cargar_datos_calendar"; }
...
$(document).on("click",".div_modal",function(e){
 ...
 $("#capa_para_edicion").html("");
  ...
  $(document).on("submit",".formarchivo",function(e){
        ...
        if(nombreform=="f_cargar_datos_calendar" ){ var miurl="cargar_datos_calendar";  var divresul="notificacion_resul_fcde"}
